/* ----------------------------------------------------------------------------------------------------------------------------
* Classe Bemafi32.cs - Data desconhecida entre 2011 e 2012 (versão antiga de 12/06/2008)
* Desenvolvida por: Fabricante do ECF Bematech
* Descrição: Classe C# que faz interface com as DLLs dos ECFs e contém os métodos respectivos
* 
* Revisada:
* Revisão 1: Dia 11/07/2013 - Copiei a classe de interface NOVA baseada nos Exemplos do Fabricante do ECF... Tudo OK!
*
* Mais informações: Classe de interface com a Dll do Fabricante
--------------------------------------------------------------------------------------------------------------------------- */
...
{
    public class clsInterfaceBematech
    {
