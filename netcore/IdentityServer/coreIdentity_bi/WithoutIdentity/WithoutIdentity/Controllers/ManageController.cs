...
namespace WithoutIdentity.Controllers
{
    public class ManageController : Controller
    {
        ...
        #region Index (telas de edição)
        [HttpGet]
        public async Task<IActionResult> Index()
        {
            //na Index de edição do usuário eu carrego os dados do BD e retorno no DTO
            //nota: Esse "User" está no ControllerBase e contém os dados do usuário logado
        ...
        public async Task<IActionResult> Index (IndexViewModel model)
        {
            ...
            if (email != model.Email) //verifico se o e-mail que o usuário tem (no banco) é diferente do que ele atualizou, se for, atualizo
            {
