...
using ExternalProviders.Models.AccountViewModels;
using ExternalProviders.Services;

namespace ExternalProviders.Controllers
{
    [Authorize]
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        //varre todos os autenticathions tokens recebidos e salva no banco de dados...
