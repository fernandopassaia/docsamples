...
namespace NFe.UI
{
    ...
    public partial class menu : MetroFramework.Controls.MetroUserControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            uninfeDummy.mainForm.Text = Propriedade.NomeAplicacao + " - Transmissor Fiscal";
        ...
        public void UpdateControles()
        {
            ...
            //metroTile_Servicos.Visible =  metroTile_CadastroContrib.Visible = Empresas.CountEmpresasNFe > 0; //FERNANDO: COMENTEI PRA SUMIR COM ESSE MENÚ
        }
